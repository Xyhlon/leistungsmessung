...
$S$, und die nicht nutzbare Blindleistung, $Q$, berechnet
werden.~\cite[]{herbert_leistungsmessung_nodate}
...
diesem nur das Symbol $P_0$ gegeben wurde, weil es die Einheit Watt hat.
Bei der ohmschen Modellierung kann nämlich kein Energiefluss bei einer Spannung von
$\SI{0}{\volt}$ stattfinden, da keine Potentialdifferenz vorhanden ist, welche
einen Stromfluss verursachen könnte. 

Zudem wurde, \autoref{eq:fitstrom},
...
\begin{table}[H]
	...
	\centering
	\include{./tables/messreihe_aufgabe3_scheinleistung}
\end{table}
